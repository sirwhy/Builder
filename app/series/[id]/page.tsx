      ...
      <div className="max-w-7xl mx-auto px-6 pt-28 pb-16">
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            ...
            <select className="px-5 py-3 text-sm text-gray-300 bg-white/5 backdrop-blur-sm border border-purple-500/20 rounded-xl hover:border-purple-500/40 transition-all duration-300">
              <option>Newest First</option>
              <option>Oldest First</option>
            </select>
          </div>

          <div className="space-y-3 max-h-[500px] overflow-y-auto rounded-2xl bg-white/5 backdrop-blur-sm p-5 border border-purple-500/20">
